    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <!-- <li class="treeview">
         ...
         <li>
            <a href="team.php"><i class="fa fa-circle-o"></i>Teams</a>
          </li>
        <li>
            <a href="tappointments.php"><i class="fa fa-circle-o"></i>Appointments </a>
         </li>
         <li>
            <a href="approved_appointments.php"><i class="fa fa-circle-o"></i>Approved Appointment</a>
          </li>
