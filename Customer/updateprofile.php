...
<form style="padding-left: 100px; padding-top: 50px; padding-right: 300px">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="CNIC" class="form-control" name="cnicno" id="cnicno" value="<?php echo $row['cnic_no'];?>" onkeypress="validateNumber(event)" maxlength="13">
    </div>
  </div>
  <!-- Grid row -->
...
<?php
        ...
        if (isset($_REQUEST['updt'])) {
          if (($_REQUEST['username'] == "") || ($_REQUEST['inputEmail4'] == "") || ($_REQUEST['phoneno'] == "") || ($_REQUEST['inputAddress'] == "") || ($_REQUEST['inputCity'] == "") || ($_REQUEST['cnicno'] == "")) {            
            ...
            $sql = "UPDATE users SET username = '$usrnme1', email = '$inpteml', phooneno = '$phno', city = '$inptcty', address = '$inptadrs', cnic_no = '$cnno' WHERE id='$id'";
