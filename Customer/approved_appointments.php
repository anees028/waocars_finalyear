...
<div class="row">
  ...
  <thead class="thead-dark">
    ...
    while($row = mysqli_fetch_array($result))
    {
      ...
      echo "<td>". $row['shop_assign']."</td>";
      echo "<td>";
      echo "<form Action='approved_appointments1.php' method='POST'>";
       echo "<input type='hidden' name='id' value=".$row['ap_id']."><button type='submit' class='btn btn-info mr-3' name='edit' value='Edit'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-eye' viewBox='0 0 16 16'>
